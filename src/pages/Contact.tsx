  ...
  return (
    <div className="flex flex-col w-full">
      <div className="container mx-auto px-6 lg:px-12 pt-32">
        <Breadcrumbs items={[{ label: t.nav.company }, { label: t.contact.breadcrumb }]} />
      </div>
      <PageHero
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid md:grid-cols-2 gap-0 border border-border max-w-4xl">
            ...
            <div className="p-8 md:p-10 border-b md:border-b-0 md:border-r border-border flex flex-col gap-5">
              ...
              <div>
                <p className="text-xs font-medium text-foreground/30 uppercase tracking-widest mb-2">{t.contactPage.support.eyebrow}</p>
            ...
            <div className="p-8 md:p-10 flex flex-col gap-5 bg-foreground/[0.015]">
              ...
              <div>
                <p className="text-xs font-medium text-foreground/30 uppercase tracking-widest mb-2">{t.contactPage.general.eyebrow}</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0 border border-border border-t-0 max-w-4xl">
            {[
              {
                icon: Activity,
                label: t.contactPage.links.status.label,
                desc: t.contactPage.links.status.desc,
              ...
              {
                icon: BookOpen,
                label: t.contactPage.links.docs.label,
                desc: t.contactPage.links.docs.desc,
